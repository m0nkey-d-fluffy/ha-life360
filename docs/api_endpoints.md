...
| POST | `/v3/users/devices` | Register/update user's device |
...
| GET | `/v6/devices?activationStates=activated,pending,pending_disassociated` | List device activation states |
